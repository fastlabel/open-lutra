...
While the major version is `0`, minor releases may include breaking changes — see
[Release status](README.md#release-status) in the README for the current stability
